    ...
    <div className="flex flex-col gap-4 p-4 md:p-8">
      ...
      <Tabs defaultValue="overview" className="space-y-4">
        <TabsList className="flex flex-wrap">
          ...
          <TabsTrigger value="productivity">Worker Productivity</TabsTrigger>
        ...
        <TabsContent value="overview" className="space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <Card className="p-6">
              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
                  <BarChart data={productPerformanceData.slice(0, 5)}>
                    <CartesianGrid strokeDasharray="3 3" />
                    <XAxis dataKey="name" />
                    <YAxis yAxisId="left" />
        ...
        <TabsContent value="productivity" className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <Card className="p-6">
              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
                  <ComposedChart data={workerData.slice(0, 6)}>
                    <CartesianGrid strokeDasharray="3 3" />
                    <XAxis dataKey="name" />
                    <YAxis yAxisId="left" />
        ...
        <TabsContent value="financial" className="space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <Card className="p-6">
              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
                  <BarChart layout="vertical" data={productPerformanceData.sort((a, b) => b.growth - a.growth)}>
                    <CartesianGrid strokeDasharray="3 3" />
