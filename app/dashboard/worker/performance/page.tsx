...
import { BarChart, Calendar, CheckCircle, Clock, TrendingDown, TrendingUp, Users } from "lucide-react"
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-2">
        <h1 className="text-3xl font-bold">Worker Performance Analytics</h1>
        <p className="text-muted-foreground">
          Track and analyze worker productivity, efficiency, and performance metrics
        </p>
      </div>
