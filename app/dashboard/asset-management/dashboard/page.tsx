...
import { Download, Settings, Package, Wrench, Trash2 } from "lucide-react"
import {
  PieChart,
  Pie,
  Cell,
...
const assetCategoriesData = [
  { name: "Storing Assets", value: 45, color: "#8884d8" },
  { name: "Lifting Assets", value: 30, color: "#82ca9d" },
  { name: "Transportation Assets", value: 20, color: "#ffc658" },
  { name: "Manufacturing Assets", value: 15, color: "#ff8042" },
  { name: "IT Assets", value: 10, color: "#0088fe" },
  { name: "Office Assets", value: 8, color: "#00C49F" },
]
...
const statusDistributionData = [
  { name: "Active", value: 112, color: "#4ade80" },
  { name: "Under Maintenance", value: 12, color: "#facc15" },
  { name: "Decommissioned", value: 4, color: "#f87171" },
]
...
const maintenanceTypesData = [
  ...
  { name: "Corrective", value: 25, color: "#facc15" },
  { name: "Repair", value: 10, color: "#f87171" },
]

// Sample data for location distribution
const locationDistributionData = [
  { name: "Warehouse 1", value: 50, color: "#8884d8" },
  { name: "Warehouse 2", value: 35, color: "#82ca9d" },
  { name: "Production Floor", value: 25, color: "#ffc658" },
  { name: "Office Building", value: 15, color: "#ff8042" },
  { name: "Dump Yard", value: 3, color: "#0088fe" },
]
...
export default function AssetDashboardPage() {
  ...
  return (
    <div className="space-y-6 pl-4">
      <PageHeader title="Asset Dashboard" description="Comprehensive analytics and reports about your assets" />
              ...
              <div style={{ width: "100%", height: 300 }}>
                <ResponsiveContainer width="100%" height="100%">
                  ...
                  >
                    ...
                    <Legend />
                    <Bar dataKey="value" name="Value ($)" fill="#8884d8" radius={[4, 4, 0, 0]} />
                  </BarChart>
                </ResponsiveContainer>
              </div>
            </CardContent>
                ...
                <div style={{ width: "100%", height: 300 }}>
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                      ...
                      <Tooltip content={<CustomTooltip />} />
                      <Legend />
                      <Line type="monotone" dataKey="active" name="Active" stroke="#4ade80" strokeWidth={2} />
                      <Line
                        type="monotone"
                        dataKey="maintenance"
              ...
              <div style={{ width: "100%", height: 300 }}>
                <ResponsiveContainer width="100%" height="100%">
                  ...
                  >
                    ...
                    <Tooltip content={<CustomTooltip />} />
                    <Legend />
                    <Bar dataKey="active" name="Active" stackId="a" fill="#4ade80" radius={[4, 0, 0, 0]} />
                    <Bar
                      dataKey="maintenance"
                      name="Under Maintenance"
                      stackId="a"
                ...
                <div style={{ width: "100%", height: 300 }}>
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                      ...
                      <Tooltip content={<CustomTooltip />} />
                      <Legend />
                      <Bar dataKey="count" name="Asset Count" fill="#8884d8" radius={[4, 4, 0, 0]} />
                    </BarChart>
                  </ResponsiveContainer>
                </div>
              </CardContent>
