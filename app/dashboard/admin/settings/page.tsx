...
import { Bell, Clock, Database, Globe, Mail, Save, Shield, Cog } from "lucide-react"
...
export default function SystemSettingsPage() {
  ...
  return (
    <div className="flex flex-col gap-4">
      <PageHeader title="System Settings" description="Configure and manage system-wide settings" />
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid gap-2">
                ...
                <Input
                  id="stripe-api-key"
                  defaultValue="sk_test_
"
                />
              </div>
              <div className="grid gap-2">
                ...
                <div className="flex gap-2">
                  <Input id="api-key" defaultValue="wf_api_XXXXXXXXXXXXXXXXXXXXXXXX" readOnly />
